...
;; Ported from Clojure's own clojure/datafy.clj. Clojure also datafies a
;; java.lang.Class into its reflected members; that arm is absent here because it
;; is clojure.reflect, which reads JVM bytecode. Every other arm — Throwable,
;; IRef, Namespace — and datafy/nav themselves behave exactly as on the JVM.
