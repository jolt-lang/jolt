...
(def-var! "clojure.core" "register-protocol-defaults!" register-protocol-defaults!)
(def-var! "clojure.core" "register-protocol-extension!" register-protocol-extension!)
