  ...
  (if (>= i end)
      ...
      (let ((c (string-ref src i)))
        (case c
          ...
          ((#\1 #\2 #\3 #\4 #\5 #\6 #\7 #\8 #\9)
           (values (string->symbol (string #\\ c)) (+ i 1)))
          (else (values c (+ i 1)))))))
