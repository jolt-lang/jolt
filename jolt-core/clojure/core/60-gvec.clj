...
;; clojure.lang statics the bodies call (Murmur3, Util, SeqIterator,
;; PersistentList/EMPTY) are host-static shims. Kept as close to the reference
;; as it loads; the only edits are dropping its in-ns and reflection flag.
